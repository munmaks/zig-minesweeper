...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("zig_minesweeper", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zig_minesweeper" is the name you will use in your source code to
                // import this module (e.g. `@import("zig_minesweeper")`). The name is
